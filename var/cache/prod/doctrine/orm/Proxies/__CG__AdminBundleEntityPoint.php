 ...
 */
class Point extends \AdminBundle\Entity\Point implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\Point' . "\0" . 'id', '' . "\0" . 'AdminBundle\\Entity\\Point' . "\0" . 'name', '' . "\0" . 'AdminBundle\\Entity\\Point' . "\0" . 'address', '' . "\0" . 'AdminBundle\\Entity\\Point' . "\0" . 'lat', '' . "\0" . 'AdminBundle\\Entity\\Point' . "\0" . 'lng'];
        }
