 ...
 */
class Passenger extends \AdminBundle\Entity\Passenger implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\Passenger' . "\0" . 'name', '' . "\0" . 'AdminBundle\\Entity\\Passenger' . "\0" . 'phone', '' . "\0" . 'AdminBundle\\Entity\\Passenger' . "\0" . 'created', 'id', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
